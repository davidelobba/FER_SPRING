...
import numpy as np
import onnx
import landmark.vision.utils.box_utils_numpy as box_utils
...
from landmark.common.utils import BBox,drawLandmark,drawLandmark_multiple, rotate, rotate_by_nose
...
import onnx
import onnxruntime
onnx_model_landmark = onnx.load("landmark/onnx/landmark_detection_56_se_external.onnx")
onnx.checker.check_model(onnx_model_landmark)
ort_session_landmark = onnxruntime.InferenceSession("landmark/onnx/landmark_detection_56_se_external.onnx")
def to_numpy(tensor):
...
label_path = "landmark/models/voc-model-labels.txt"

onnx_path = "landmark/models/onnx/version-RFB-320.onnx"
...
def extract_landmark(orig_image, image_back=False):
    resize_size = 128
    threshold = 0.7
    sum = 0
    faces = []
